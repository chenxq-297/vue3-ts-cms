...
const { departmentOptions } = storeToRefs(mainStore)
...
<template>
  ...
  <PageTable headerName="部门管理" :table-config="tableConfig" :tableDatas="pageList" :paginOpen="true" :pagin-config="paginConfig" @paginConfigFn="changePaginConfig">
